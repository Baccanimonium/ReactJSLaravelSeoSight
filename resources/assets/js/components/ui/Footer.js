...
class  Footer extends Component{
    ...
    updateComponent(){
        if(this.props.elementIsInView && !this.state.inViewTrigger || this.props.elementHasBeenInView && !this.state.inViewTrigger){
            this.setState({
                inViewTrigger: true
            })
        }
    ...
    componentDidMount() {
        const height = this.divElement.clientHeight+20;
        this.setState({
            divHeight: height,
        })
        window.addEventListener("scroll",(e) => this.updateComponent (e) )
    }
    componentWillUnmount(){
        window.removeEventListener("scroll",(e) => this.updateComponent (e))
    }
    handleScrollUp(e){
        e.preventDefault()
        window.scrollTo(0, 0)
    ...
    render(){
        const svgStyle={ display: 'none'}
        const footerHeight ={
            height: this.state.divHeight
        }
        const opacitySVGStyle= this.state.inViewTrigger?{ opacity: 1}: { opacity: 0}
        return (
            ...
            {/*<!-- End Subscribe Form -->*/}
            {/*<!-- Footer -->*/}
            <div className="block-footer-height" style={footerHeight}></div>
            <footer className="footer js-fixed-footer" id="site-footer" ref={ (divElement) => this.divElement = divElement}>
                        ...
                        <div className="info">
                            <div className="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                <div className="heading">
                                    <h3 className="heading-title">Seosight Company!</h3>
                                    <div className="heading-line">
                                        <span className="short-line"></span>
                                        <span className="long-line"></span>
                                    </div>
                                    <p className="heading-text">Qolor sit amet, consectetuer adipiscing elit, sed diam
                                        nonummy nibham
                                ...
                                <div className="socials">
                                    ...
                                    <a href="" className="social__item">
                                        <img src={`${this.context.appUrl}svg/rss.svg`} alt="rss"/>
                                    </a>
                                </div>
                            </div>
                    ...
                    {this.state.inViewTrigger ? <div className="row">
                        <div className="contacts">
                            ...
                            <div className="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                <div className="contacts-item">
                                    <div className="icon js-animate-icon">
                                        <MtSvgLines animate={ true } duration={ 1000 } stagger={100}>
                                            <svg style={opacitySVGStyle}
                                                 enableBackground="new 0 0 64 64"
                                                 version="1.1" viewBox="0 0 64 64"
                                                 xmlSpace="preserve"
                ...
                <span>
                Copyright © 2016 <a href="index.html" className="sub-footer__link">Seosight,</a>
        Designed by <a href="https://themeforest.net/user/themefire/portfolio">themefire</a>
        </span>

            <span>Developed by <a
                href="https://themeforest.net/user/crumina/portfolio">Crumina</a></span>
            <span>Only on <a
                href="https://themeforest.net/user/crumina/portfolio">Envato Market</a></span>

            <a className="back-to-top" onClick={(e) => this.handleScrollUp(e)}>
                <svg className="back-to-top">
                    <use xlinkHref="#to-top" ></use>
                </svg>
            </a>
        </div>
        </div>
...
export default ReactInview(InviewOptions)(Footer)
