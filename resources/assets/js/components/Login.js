...
class Login extends Component {
    ...
    handleLogin(e) {
        ...
        const formData = {
            ...
            remember: this.state.remember? this.state.remember : ''
        }
                        ...
                        <div className="container">
                            <div className="row medium-padding120">
                                <div className="heading align-center" >
                                    <h4 className="h1 heading-title" ref={ (h4Element) => this.h4Element = h4Element} style={{display: 'inline'}}>
                                    ...
                                    <p>Welcome back {authData.user.name}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <form id="login-form" action="" onSubmit={(e) =>this.handleRegister(e)} method="post">
                                ...
                                <div className="form-group">
                                    <div className="col-md-5 col-md-offset-4">
                                        <div className="remember-wrap" onChange={(e) =>handleToggleCheckBox(e)}>
